...
public class CartaoServiceTest {
	...
	public void validaBandeiraMastercard() {
		List<String> cartoesValidosMastercard = Arrays.asList("5173440237268170", "5235073413024061", "5390912365174393", "5450913466651666", "5580999272109059");
		try {
			cartoesValidosMastercard.forEach(cartaoValidoParaMastercard -> {
				cartaoService.inserir(new Cartao(9, "Nubank", "Mastercard", cartaoValidoParaMastercard, 10.00));
				assertTrue(true);
			});
		} catch (Exception e) {
			Assert.fail();
